...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnFirebaseRegister = findViewById(R.id.btnFirebaseRegister);
        ...
        btnFirebaseRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((emailId.isEmpty() || emailId.length() > 30) && !Patterns.EMAIL_ADDRESS.matcher(emailId).matches()) {
                ...
                if ((!username.isEmpty() && username.length() < 30 &&
                        ...
                        && !emailId.isEmpty() && emailId.length() < 30) &&
